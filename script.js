document.addEventListener('DOMContentLoaded', () => {
    ...
    // Balloon & Envelope Animation Sequence
    ...
    startDeliveryBtn.addEventListener('click', () => {
        ...
        // Stage 1: Balloon Flies Up, Envelope Scales Up
        deliveryStage.classList.add('animating');

        // Stage 2: Flap Opens & Letter Slides Up
        setTimeout(() => {
            deliveryStage.classList.add('open');
        }, 1500);

        // Stage 3: Transition to Notebook
        setTimeout(() => {
